...
def generate(testdata_folder, testdata_file, output_folder, output_file, model_path, tensor_parallel_size, max_length, trust_remote_code, batch_size=128):
...
generate(testdata_folder=args.testdata_folder,
