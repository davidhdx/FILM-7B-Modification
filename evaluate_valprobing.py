...
with open('/content/ValProbing-32K/document_bi_32k.jsonl', 'r', encoding='utf-8') as f:
    label_infos = []
...
with open('/content/FILM/VaLProbing/VaLProbing-32K/document_bi_32k_skip_list.json', 'r', encoding='utf-8') as f:
...
for model_name, color_str, ecolor_str, linestyle in model_infos:
    ...
    with open('/content/FILM/VaLProbing/VaLProbing-32K/results/' + model_name + '/sample_document_bi_32k.jsonl', 'r', encoding='utf-8') as f:
...
with open('/content/ValProbing-32K/code_backward_32k.jsonl', 'r', encoding='utf-8') as f:
    label_infos = []
    for line in tqdm(f.readlines()):
        info = json.loads(line)
        gt = info['completion']
...
with open('/content/FILM/VaLProbing/VaLProbing-32K/code_backward_32k_skip_list.json', 'r', encoding='utf-8') as f:
    skip_list = json.load(f)
...
for model_name, color_str, ecolor_str, linestyle in model_infos:
    ...
    with open('/content/FILM/VaLProbing/VaLProbing-32K/results/' + model_name + '/sample_code_backward_32k.jsonl', 'r', encoding='utf-8') as f:
        pred_infos = [json.loads(line) for line in f.readlines()]
        for idx, (pred_info, label_info) in enumerate(tqdm(zip(pred_infos, label_infos))):
...
with open('/content/ValProbing-32K/database_forward_32k.jsonl', 'r', encoding='utf-8') as f:
    label_infos = []
    for line in tqdm(f.readlines()):
        info = json.loads(line)
        gt_label = info['label']
...
with open('/content/FILM/VaLProbing/VaLProbing-32K/database_forward_32k_skip_list.json', 'r', encoding='utf-8') as f:
    skip_list = json.load(f)
...
for model_name, color_str, ecolor_str, linestyle in model_infos:
    ...
    with open('/content/FILM/VaLProbing/VaLProbing-32K/results/' + model_name + '/sample_database_forward_32k.jsonl', 'r', encoding='utf-8') as f:
        pred_infos = [json.loads(line) for line in f.readlines()]
        for idx, (pred_info, label_info) in enumerate(tqdm(zip(pred_infos, label_infos))):
